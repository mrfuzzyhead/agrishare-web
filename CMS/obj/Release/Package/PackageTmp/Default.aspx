...
<body ng-controller="AppController" id="Body" runat="server">
    ...
    <div class="gl-lightbox" ng-if="app.slideshow.visible">
        <div class="titlebar">
            <div>
                {{app.slideshow.photos[app.slideshow.currentIndex].Title}}
            </div>
            <div>
        ...
        <div class="photo">
            ...
            <div ng-repeat="photo in app.slideshow.photos" style="background-image:url({{photo.ZoomPath}})" ng-class="{'visible':$index==app.slideshow.currentIndex}"></div>                
        </div>
    </div>
